    ...
    , myProgramID(0)
{
    ...
    myVertexShader = new Shader("../../Data/Shaders/NormalsVertexShader.glsl", ShaderType::Vertex);
    myFragmentShader = new Shader("../../Data/Shaders/NormalsFragmentShader.glsl", ShaderType::Fragment);
